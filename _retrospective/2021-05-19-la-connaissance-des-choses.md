...
description-en: >-
  ...
  never completely black, it is stained with yellow, green, blue, never
  sinister. The whites are little "dirty" (in the painter's words). The reds are
  vermilion and carmine, blood-like. The patches of colors are almost always
  "scraped", disclosing sometimes slightly, often frankly the color of the
  underlying layer. In some places one can perceive the texture of the canvas. 
